...
public class GeografijaDAO {
        ...
        private GeografijaDAO() throws SQLException, ClassNotFoundException {
            ...
            try {
                ...
                stmt.executeUpdate("INSERT OR IGNORE INTO grad (id,naziv,broj_stanovnika,drzava) VALUES (1,'Pariz',10,1)");
                stmt.executeUpdate("INSERT OR IGNORE INTO grad (id,naziv,broj_stanovnika,drzava) VALUES (2,'London',20,2)");
                stmt.executeUpdate("INSERT OR IGNORE INTO grad (id,naziv,broj_stanovnika,drzava) VALUES (3,'Beč',30,3)");
                stmt.executeUpdate("INSERT OR IGNORE INTO grad (id,naziv,broj_stanovnika,drzava) VALUES (4,'Manchester',40,2)");
                stmt.executeUpdate("INSERT OR IGNORE INTO grad (id,naziv,broj_stanovnika,drzava) VALUES (5,'Graz',50,3)");
            }catch(SQLException e) {
                regenerisiBazu();
                try {
                    Statement stmt = conn.createStatement();
